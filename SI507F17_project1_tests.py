...
class testCardClass(unittest.TestCase):
    ...
    def test_card_string(self):
        ...
        self.assertEqual(str(ace_of_spades), "Ace of Spades",
                         "Output should be Ace of Spades")
...
class testDeckClass(unittest.TestCase):
    ...
    # A helper function determine if two decks have high similarity.
    # Two decks are considered different
    ...
    def test_war_game_result(self):
        ...
        while i > 0:
            ...
            if res[0] == "Player1":
                ...
                self.fail("Game winner should be one of the \
                	      following: Player1, Player2, Tie")
            i -= 1


class testShowSong(unittest.TestCase):
    def test_show_song_input_type(self):
        with self.assertRaises(TypeError, "There should be a TypeError \
    ...
    def test_show_song_search(self):
        ...
        self.assertTrue(test_song in song_objs,
                        "Searching mechanism is not working correctly")
